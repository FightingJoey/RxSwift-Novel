...
open class DefaultRefreshFooter:UIView, RefreshableFooter{
    ...
    fileprivate func udpateTextLabelWithMode(_ refreshMode:RefreshMode){
        switch refreshMode {
        case .scroll:
            textLabel.attributedText = textDic[.pullToRefresh]
        case .tap:
            textLabel.attributedText = textDic[.tapToRefresh]
        case .scrollAndTap:
            textLabel.attributedText = textDic[.scrollAndTapToRefresh]
        }
    }
    
    fileprivate var tap:UITapGestureRecognizer!
    fileprivate var textDic = [RefreshKitFooterText:NSAttributedString]()
    /**
     This function can only be called before Refreshing
     */
    open  func setText(_ text:NSAttributedString,mode:RefreshKitFooterText){
        textDic[mode] = text
        textLabel.attributedText = textDic[.pullToRefresh]
    }
    override init(frame: CGRect) {
        ...
        textDic[.pullToRefresh] = NSAttributedString(string: PullToRefreshKitFooterString.pullUpToRefresh)
        textDic[.refreshing] = NSAttributedString(string: PullToRefreshKitFooterString.refreshing)
        textDic[.noMoreData] = NSAttributedString(string: PullToRefreshKitFooterString.noMoreData)
        textDic[.tapToRefresh] = NSAttributedString(string: PullToRefreshKitFooterString.tapToRefresh)
        textDic[.scrollAndTapToRefresh] = NSAttributedString(string: PullToRefreshKitFooterString.scrollAndTapToRefresh)
        udpateTextLabelWithMode(refreshMode)
...
// MARK: - Refreshable  -
    ...
    open func didBeginRefreshing() {
        ...
        textLabel.attributedText = textDic[.refreshing];
    ...
    open func didUpdateToNoMoreData(){
        ...
        textLabel.attributedText = textDic[.noMoreData]
    }
